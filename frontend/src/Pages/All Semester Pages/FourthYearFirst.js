...
const FourthYearFirst = () => {
  ...
  const addUser = (data) => {
    ...
    Axios.put('https://letmedo-hqeveqd7b9anh5bv.southeastasia-01.azurewebsites.net/api/fourthyearfirst', { email: user.email, updates: [data] })
      .then(() => {
...
export default FourthYearFirst;
