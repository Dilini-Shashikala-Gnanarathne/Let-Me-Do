...
const getSemester = async (req, res) => {
  ...
  try {
    ...
    if (record) {
      ...
      for (let i = 0; i < record.thirdyearfirst.length; i++) {
        let user = record.thirdyearfirst[i].grade; 
        let credit = record.thirdyearfirst[i].subjectcredit;
        console.log(user);
